				        ...
				        <div class="row">
										<div class="col-xs-12">
												...
												<div class="row">
														...
														<div class="col-xs-4">
																<a href="#" class="interessed">Je veux y aller</a>
														</div>
														<div class="col-xs-4 next">
																<?php next_post_link('%link', '<img src="http://localhost:8888/Bordeaux-burlesque-festival/site/wp-content/uploads/2016/11/chevron-d.png">'); ?>
														</div>
												</div>
										</div>
